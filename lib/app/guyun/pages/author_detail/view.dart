...
Widget buildView(
  ...
  return Scaffold(
    ...
    body: SafeArea(
      ...
      onLoading: () => dispatch(AuthorDetailActionCreator.onLoadData()),
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                (context, index) => GestureDetector(
                  ...
                  child: _buildItem(state.worksList[index]),
                  onTap: ()=> Navigator.of(viewService.context).pushNamed('guyun_works_detail',arguments: {'work':state.worksList[index]}),
                ),
                childCount:
                    state.worksList.length > 0 ? state.worksList.length : 0),
          ),
        ],
      ),
    )),
